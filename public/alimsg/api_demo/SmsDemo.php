...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAI9FKWMP0KZ1fy"; // AccessKeyId

        $accessKeySecret = "1xQVIOGjo7U8sKcc2CAqMNFQu5vchC"; // AccessKeySecret
    ...
    public static function sendSms() {
        ...
        // 必填，设置短信接收号码
        $request->setPhoneNumbers("18810019197");

        // 必填，设置签名名称，应严格按"签名名称"填写，请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/sign
        $request->setSignName("筑友锐成");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_129475237");
...
(
    [Message] => OK
    [RequestId] => F05BE17D-9D32-4129-B76A-1AA7761388D0
    [BizId] => 827713863509156308^0
    [Code] => OK
)
stdClass Object
(
    [Message] => 1881001s9197 invalid mobile number
    [RequestId] => 4008BC52-6CEB-4A31-9D8A-235153A18A2E
    [Code] => isv.MOBILE_NUMBER_ILLEGAL
)
stdClass Object
(
    [Message] => 签名不合法(不存在或被拉黑)
    [RequestId] => EFCBFFA6-E2D2-4ECD-8C5E-BC0B19000109
